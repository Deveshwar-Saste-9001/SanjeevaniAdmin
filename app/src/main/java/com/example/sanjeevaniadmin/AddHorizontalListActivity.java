...
public class AddHorizontalListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_horizontal_list);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Add Grid List");
        loadingDialog = new Dialog(AddHorizontalListActivity.this);
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(position.getText())) {
                    Toast.makeText(AddHorizontalListActivity.this, "Please select Index", Toast.LENGTH_SHORT).show();
                } else {
                    loadingDialog.show();
                    Map<String, Object> productListMap = new HashMap<>();
                    productListMap.put("index", Long.parseLong(position.getText().toString()));
                    productListMap.put("view_type", (long) 2);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        finish();
                                        Toast.makeText(AddHorizontalListActivity.this, "added successful", Toast.LENGTH_SHORT).show();
                                    } else {
                                        loadingDialog.dismiss();
                                        finish();
                                        Toast.makeText(AddHorizontalListActivity.this, "not added please try again", Toast.LENGTH_SHORT).show();
                                    }
        ...
        final LinearLayoutManager homepageLayoutManager = new LinearLayoutManager(AddHorizontalListActivity.this);
        ...
        if (DatabaseQuries.selectproductList.size() == 0) {
            DatabaseQuries.loadWishList(selectProductRecyclerView, AddHorizontalListActivity.this);
        } else {
            selectProductAdapter = new SelectProductAdapter(DatabaseQuries.selectproductList, AddHorizontalListActivity.this);
